...
export class UserInterestResolverBase {
  ...
  async createUserInterest(
    ...
    return await this.service.createUserInterest({
      ...
      data: {
        ...
        interest: args.data.interest
          ? {
              connect: args.data.interest,
            }
          : undefined,
  ...
  async getInterest(
    ...
    const result = await this.service.getInterest(parent.id);
  ...
  async getUser(@graphql.Parent() parent: UserInterest): Promise<User | null> {
